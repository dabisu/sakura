...
sakura_add_tab()
{
    ...
    vte_terminal_set_audible_bell (VTE_TERMINAL(term->vte),
                                   sakura.audible_bell ? TRUE : FALSE);
    vte_terminal_set_visible_bell (VTE_TERMINAL(term->vte),
                                   sakura.visible_bell ? TRUE : FALSE);
